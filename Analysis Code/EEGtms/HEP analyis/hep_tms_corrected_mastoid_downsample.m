...
save2folder= '/data/p_02186/TMS_ECG2/analyses/EEGtms/merge/reref/HEP_preTMS_ica2/tms_corrected'; mkdir(save2folder); cd(save2folder);
...
save('grandtrials_04','grandtrials','subnum','epochnum')
%%
clc; clear;
save2folder= '/data/p_02186/TMS_ECG2/analyses/EEGtms/merge/reref/HEP_preTMS_ica2/tms_corrected'; cd(save2folder);
load('grandtrials')
