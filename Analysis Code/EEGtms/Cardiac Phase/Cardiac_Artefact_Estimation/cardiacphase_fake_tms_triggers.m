...
eeglab
%%
eegfolder= '/data/p_02186/TMS_ECG2/analyses/EEGtms/merge/old_analyses_tmseeg';
...
load("/data/p_02186/TMS_ECG2/analyses/EEGtms/merge/cardiacphase_fake/fakeecg_equal_sysdys_tms.mat")
for s = 1:subnum
    subid = subj_names{s}; subfolder=[eegfolder '/' subid '/'];
    EEG = pop_loadset([subfolder subid '_tmsall_default.set']);
    EEG= pop_select(EEG, 'nochannel', {'ECG','FDI'});
