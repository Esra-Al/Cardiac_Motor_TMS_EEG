...
for s = 1:subnum
    ...
    EEG = pop_loadset([subfolder subid '_tmsall_default_1_2_3_4_5_6.set']);
    h1 = msgbox('Running ICA2,now!');
    EEG = pop_runica(EEG, 'icatype' ,'fastica','g','tanh','approach','symm');
    EEG = eeg_checkset(EEG);
    close(h1);
    EEG = pop_saveset(EEG, 'filename', [subid '_tmsall_default_1_2_3_4_5_6_7.set'], 'filepath', subfolder, 'version', '7.3');
end